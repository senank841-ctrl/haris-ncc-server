...
class DownloadHandler(BaseHTTPRequestHandler):
    ...
    def _do_download(self, youtube_url, quality, format_type='mp4'):
        ...
        try:
            cmd = ['yt-dlp', '--concurrent-fragments', '5', '--extractor-retries', '10', '--sleep-requests', '1', '--js-runtime', 'node', '--user-agent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36']
